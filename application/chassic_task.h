...
//摇杆死区
#define CHASSIS_RC_DEADLINE 8000      //8000
...
#define CHASSIS_OPEN_RC_SCALE 20 // in CHASSIS_OPEN mode, multiply the value. 在chassis_open 模型下，遥控器乘以该比例发送到can上
