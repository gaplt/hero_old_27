...
#define Trigger_speed_PID_P 12.2f
#define Trigger_speed_PID_I 0.0f
#define Trigger_speed_PID_D 1.0f 

#define Trigger_angle_PID_P 150.0f
#define Trigger_angle_PID_I 0.0f
#define Trigger_angle_PID_D 9.5f 

#define motor1_PID_P 45.0f         //摩擦轮 45//50
#define motor1_PID_I 0.00f         //0.02//0.00
#define motor1_PID_D 26.8f               //16.8  

#define motor2_PID_P 50.0f
#define motor2_PID_I 0.00f
#define motor2_PID_D 17.5f 

#define motor1_speed1 4250       //12m/s  4440   //摩擦轮转速13m/s     //5570
#define motor2_speed1 4250         //9.5     3890
						 
#define motor1_speed2 9050          //摩擦轮转速18m/s  5550        6450
#define motor2_speed2 9050
...
#define shooting_frequency 600    //拨弹频率设置  
 
#define KEY_input 659             //按键高电平有效

#define division_angle   60.67f     //一个拨弹盘分度角度   60.67
