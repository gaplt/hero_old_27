...
#define PITCH_GYRO_ABSOLUTE_PID_KP  15.0f//26   //150    50	110//45
#define PITCH_GYRO_ABSOLUTE_PID_KI  0.0f
#define PITCH_GYRO_ABSOLUTE_PID_KD  0.1f	//0.1f
...
#define PITCH_SPEED_PID_KP        8000.0f///////////////////////7000	4000
#define PITCH_SPEED_PID_KI        200.0f//60.0f
#define PITCH_SPEED_PID_KD        0.0f  //45.0
#define PITCH_SPEED_PID_MAX_OUT   30000.0f
#define PITCH_SPEED_PID_MAX_IOUT  10000.0f

//yaw gyro angle close-loop PID params, max out and max iout
//yaw 角度环 角度由陀螺仪解算 PID参数以及 PID最大输出，积分输出
#define YAW_GYRO_ABSOLUTE_PID_KP        40.0f//35.0f //20.0f  //130 //50  不开陀螺的自瞄       有预测
#define YAW_GYRO_ABSOLUTE_PID_KI        0.0f//3.0f
#define YAW_GYRO_ABSOLUTE_PID_KD        -1.0f//0.3//-4.7//-1.0
#define YAW_GYRO_ABSOLUTE_PID_MAX_OUT   400.0f
#define YAW_GYRO_ABSOLUTE_PID_MAX_IOUT  20.0f

#define YAW_SPEED_PID_KP        7000.0f//2900.0f //3600//4500
#define YAW_SPEED_PID_KI        20.0f//20.0f
#define YAW_SPEED_PID_KD        0.0f//20
#define YAW_SPEED_PID_MAX_OUT   30000.0f
#define YAW_SPEED_PID_MAX_IOUT  5000.0f

//遥控器输入死区，因为遥控器存在差异，摇杆在中间，其值不一定为零
#define RC_DEADBAND   8000 //原来的值10，yao

#define gimbal_pitch_CHANNEL  3
//pitch和yaw的遥控器通道号码
#define gimbal_yaw_CHANNEL    2

#define Motor_Angle_to_Rad_YAW    -0.001f//自瞄跟随速度  -0.0001f
#define Motor_Angle_to_Rad_PITCH  -0.001f//自瞄跟随速度  -0.0001f

//#define yaw_offset_ecd    4250    //yaw轴电机头正方向电机值   小绿2880    小黑150    4250   //小黑2号6000    全向轮3915

#define yaw_ecd         3626//3760   //yaw轴电机头正方向电机值   小绿2880    小黑150    4250   //小黑2号6000    全向轮3915
#define yaw_back_ecd    6583   //2503

#define pitch_offset_ecd  58      //pitch轴电机水平方向电机值   小绿2800    小黑6780
